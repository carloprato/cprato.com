        ...
        <div class="row content">
            <div class='col_12 content_paragraph'>
                {foreach:recent_posts}
                    <h3>
                    <a href="{{SITE_ROOT}}/{{lang}}/blog/view_post/{{loop_element:id}}/{{loop_element:short_title}}">
                        {{loop_element:title}}
                    </a>
                    </h3>  				
                    <p>
                        {{loop_element:short_content}}...<b><a href="{{SITE_ROOT}}/{{lang}}/blog/view_post/{{loop_element:id}}/{{loop_element:short_title}}">Continue reading</a>
                    </b></p>
                    <br/>
                    <hr/>
                {endforeach}
