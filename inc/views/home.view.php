<div class='evidence_container'>
    <div class="row evidence">
        <div class='col_4 evidence_paragraph' style='padding-left:15px; text-align: left;'>
...
<?php /* Replacing Wordpress dynamic request to static HTML
        ...
        */
        ?>
 				<h2>Latest Blog Posts</h2>
									4th May 2015<br />					<h3>Carlo Prato &#8211; A Little Thought</h3>    
					 
										11th April 2015<br />					<h3>Lily &#8211; Prerelease</h3>    
					 
										20th March 2015<br />					<h3>My i3 Budget Build</h3>    
					<p>I built my own computer during the first half of February 2015. Being on a limited budget (&lt; 500€) I decided to wait to buy the graphics card because it would increase they price of the whole build by 150-200€. I am currently using the integrated Intel HD 4400 GPU but besides the fact that &hellip; <a href="http://www.cprato.com/blog/?p=70" class="more-link">Continue reading <span class="screen-reader-text">My i3 Budget Build</span> <span class="meta-nav">&rarr;</span></a></p>
        </div>
    </div>
    <div class='fill'>
    </div>
